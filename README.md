...
A API precisa estar no ar. Subindo pelo compose da raiz (`docker compose up -d db api`)
ela responde em `http://localhost:8081`, que é o valor de `VITE_API_BASEURL` no `.env`.
